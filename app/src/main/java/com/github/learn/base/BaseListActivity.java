...
import com.github.captain_miao.rvdatabinding.common.DefaultLoadMoreFooterView;
import com.github.captain_miao.rvdatabinding.common.LayoutManagers;
import com.github.captain_miao.rvdatabinding.listener.RefreshRecyclerViewListener;
import com.github.captain_miao.uniqueadapter.library.ItemModel;

import java.util.List;

public abstract class BaseListActivity<T extends ItemModel> extends BaseActivity implements RefreshRecyclerViewListener {
    private static String TAG = BaseListActivity.class.getSimpleName();
